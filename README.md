...
Решение нужно выгрузить на Git и отправить ссылку на репозиторий на почту info@kata.academy, тема письма: «Тестовое задание Калькулятор Golang».
Если тебе нужно освежить знания о Git и Github, рекомендуем вернуться к материалам в этапе 2 нашего тестового задания, а также прочитать эту статью, в которой описаны основы работы с Git.

Далее нужно создать собственный репозиторий и добавить туда проект с решением.

Успехов тебе в выполнении тестового задания и удачи в прохождении отбора в Kata Academy! Дерзай!
